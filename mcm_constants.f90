MODULE constants
  ...
  USE mcm_subset2_Precision, ONLY: dp
  IMPLICIT NONE
  PRIVATE dp
  ...
  REAL(dp) fcppn, fppn, k14isom1, kbppn, kppn0, kppni, krppn, ncppn
...
CONTAINS
  ...
  SUBROUTINE mcm_constants(time, temp, M, N2, O2, RO2, H2O)
    ...
    !USE mcm_subset2_Global,  ONLY:LAT, LON, JDAY, SZAS, SVJ_TJ, bs,cs,ds, jfactno2, jfacto1d, &
